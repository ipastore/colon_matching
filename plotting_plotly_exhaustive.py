...
fig = px.scatter(
    ...
    y="trans_error",
    color="submap_id",
    hover_data=["image0", "image1", "mkpts0", "mkpts1", "Total_img", "Nimg_percentage", "covis_score", "rot_error"]
)
...
fig = px.scatter(
    ...
    y="rot_error",
    color="submap_id",
    hover_data=["image0", "image1", "mkpts0", "mkpts1", "Total_img", "Nimg_percentage", "covis_score", "trans_error"]
)
